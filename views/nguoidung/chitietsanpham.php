														...
														<div id="review-form">
															<div id="respond" class="comment-respond">
																...
																<form action="<?= BASE_URL . '?act=post-binhluan' ?>" method="post" id="comment-form" class="comment-form">
																	...
																	<input type="hidden" name="tai_khoan_id" value="<?=$admin['id']?>">
																	...
																	<div class="content-info-reviews">
																		<p class="comment-form-author">
																			<input value="<?= $admin['ho_ten'] ?>" id="ho_ten" name="ho_ten" placeholder="Tên người đăng  *" type="text" value="" size="30" aria-required="true" required="">
																		</p>
																		<?php if (isset($_SESSION['errors']['ho_ten'])) { ?>
																			<div class="text-danger"><?= $_SESSION['errors']['ho_ten'] ?></div>
																		<?php } ?>
																		<p class="comment-form-email">
																			<input id="email" name="email" placeholder="Email *" type="email" value="<?= $admin['email'] ?>" size="30" aria-required="true" required="">
																		</p>
