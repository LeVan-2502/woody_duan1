                                                                ...
                                                                <tr class="cart-item">
                                                                    ...
                                                                    <td class="product-quantity">
                                                                        <div class="quantity">
                                                                            ...
                                                                            <input type="number" class="qty" name="so_luong[]" data-product-id="<?= $sp['id'] ?>" step="1" min="0" max="<?= $sp['so_luong'] ?>" value="<?= $sp['so_luong'] ?>" title="Qty" size="4" placeholder="" inputmode="numeric" autocomplete="off">
