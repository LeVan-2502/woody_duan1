...
<head>
    ...
    <style>
        body.hold-transition.login-page {
            background: url('https://images.unsplash.com/photo-1469735139965-2d27590468a4?q=80&w=1932&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D');
            ...
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <tbody>
                            <?php foreach ($chiTietDonHang as $key => $dh) : ?>
                                <tr>
                                    <td><?= $key + 1 ?></td>
                                    <td>
                                        <img width="100px" src="<?= BASE_URL . $dh['hinh_anh'] ?>" alt="Ảnh sản phẩm">
                                    </td>
                                    <td><?= $dh['ten_san_pham'] ?></td>
                                    <td><?= number_format($dh['gia_san_pham'], 0, ',', '.') ?> VND</td>
                                    <td><?= $dh['so_luong'] ?></td>
                                </tr>
                            <?php endforeach ?>
                        </tbody>
                    ...
                    <div class="text-right">
                        <a class="btn btn-info" href="<?= BASE_URL . '?act=myaccount'?>">Thoát</a>
                    </div>
                </div>
            </div>
        </div>
